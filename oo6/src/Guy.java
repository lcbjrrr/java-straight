public class Guy {
    ...
    void giveCash(float v) throws InsuficientFundsException {
        if(v<this.cash) {
            this.cash=this.cash-v;
        }else {
            throw new InsuficientFundsException(v);
        }
    }
    public static void main(String[] args) {
        ...
        try{
            john.giveCash(value);
            mary.takeCash(value);
        }catch(InsuficientFundsException ifs){
            System.out.println("Insuficient funds"+ifs.getFunds());
        }
